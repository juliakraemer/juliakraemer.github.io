...
title: dissertation
description: "<h4>Data Protection by Platform : The Role of Private Actors in Shaping GDPR Compliance in the Mobile Ecosystem</h4>"
nav: true
nav_order: 6
...
<div class="d-flex flex-column flex-md-row align-items-center mt-3 mt-md-0" style ="padding-top: 50px">
  ...
  <!-- RIGHT: gif -->
  <div class ="ms-md-auto" style="width: 450px; padding-left: 50px">    <a href="https://pure.eur.nl/en/publications/data-protection-by-platform-the-role-of-private-actors-in-shaping/" target="_blank" rel="noopener">
    {% include figure.liquid loading="eager"
       path="assets/img/animated_cover.gif"
       title="Data Protection by Platform" %} </a>
  </div>
